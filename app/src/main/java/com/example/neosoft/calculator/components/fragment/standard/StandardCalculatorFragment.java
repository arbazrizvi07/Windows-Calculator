...
import com.example.neosoft.calculator.components.fragment.history.HistoryFragment;
import com.example.neosoft.calculator.components.fragment.memory.MemoryFragment;
import com.example.neosoft.calculator.components.fragment.standard_keyboard.StandardKeyboardFragment;
...
public class StandardCalculatorFragment extends BaseFragment implements StandardView, TextWatcher {
    ...
    private void onPressEqualButton() {
        ...
        try {
            ...
            mEditBottom.setText(result.intValue() + "");
        } catch (Exception e) {
